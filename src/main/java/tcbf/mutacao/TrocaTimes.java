 ...
 * @author Alexandre
 */
public class TrocaTimes extends Mutation {

    

    public TrocaTimes(HashMap<String, Object> parameters) {
        super(parameters);
 ...
 for(int i=0; i<times.length;i++){
    ...
    public Object execute(Object object) throws JMException {
       ...
       this.doMutation(solution);
        return solution;
// throw new UnsupportedOperationException("Not supported yet. Baby LALALALALALA"); //To change body of generated methods, choose Tools | Templates.
    }
